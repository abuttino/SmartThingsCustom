 ...
 */
metadata {
    definition (name: "SmartWeatherv2019-2", namespace: "abuttino", author: "abuttino") {
    ...
    tiles(scale: 2) {
        ...
        valueTile("dewPoint", "device.dewpoint", decoration: "flat", height: 1, width: 2) {
            state "default", label:'Dewpoint ${currentValue}º'
        }
        ...
        details(["temperature", "feelsLike", "weatherIcon", "humidity", "wind",
                 "dewPoint", "city", "percentPrecip", "weather", "light",
                 "rise", "set",
                 "refresh",
...
def poll() {
    ...
    if (obs) {
        ...
        sendEvent(name: "allInfo", value: obs)
